...
const ProviderDashboard: React.FC<ProviderDashboardProps> = ({ onChangePasswordClick }) => {
      ...
      <div className="p-8 md:p-10 text-white">
        ...
        {isRejected && provider?.rejectionReason && (
          <div className="mb-8 p-6 bg-red-600/30 backdrop-blur-md border border-red-500/50 rounded-2xl text-center max-w-4xl mx-auto">
            <h3 className="text-2xl font-bold text-red-300 mb-3">Application Rejected</h3>
        ...
        <div className="flex gap-12 items-start justify-between">
          ...
          <div className="flex-1">
            {provider?.logoUrl && (
              <div className="bg-white p-6 rounded-lg mb-6 inline-block">
                <img src={provider.logoUrl} alt="Provider Logo" className="h-24" />
              </div>
            )}
          ...
          <div className="flex-1 flex flex-col justify-center items-end gap-6">
            ...
            <div
              ...
              className="bg-[#201042]/70 rounded-full px-8 py-4 text-center min-w-[200px] cursor-pointer hover:bg-[#201042] transition"
            >
