            ...
            <div className="lg:col-span-2 flex flex-col gap-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div
                  ...
                  className="bg-white/10 backdrop-blur-md border border-white/20 rounded-2xl p-5 flex flex-col items-center gap-3 cursor-pointer hover:bg-white/15 transition-all"
                >
